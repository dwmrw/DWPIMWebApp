...
<body class="area-blue dw8-container">
    ...
    <dw:Dialog runat="server" ID="FeedbackDialog" Title="Restored items" ShowOkButton="true">            
        <ul id="ErrorItems" class="red" runat="server" ClientIDMode="Static" >
            <lh>Content cannot be restored:</lh>
            <asp:Literal ID="ErrorItemsPlaceholder" runat="server"></asp:Literal>
        </ul>        
        <ul id="restoredItems">
            <lh>Restored items:</lh>
