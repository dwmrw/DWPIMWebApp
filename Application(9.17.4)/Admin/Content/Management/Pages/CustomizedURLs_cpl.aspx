        ...
        <dwc:CardBody runat="server">
            ...
            <dwc:GroupBox ID="GroupSettings" runat="server" Title="Indstillinger" GroupWidth="6">
                ...
                <dwc:CheckBox runat="server" ID="LatinNormalize" Name="/Globalsettings/System/Url/LatinNormalize" Label="" />
                 <%If SystemConfiguration.Instance.GetValue("/Globalsettings/System/Url/LatinNormalize") = "True" Then%>
                    <dwc:InputTextArea runat="server" ID="LatinNormalizeCustomMappings" Name="/Globalsettings/System/Url/LatinNormalizeMappings" Label="Custom mappings" Info="List of custom character replacements. I.e ã:a will replace ã with a. Seperate with ; 'ã:a;ô:o" Rows="5"  />
                <%End If %>
            ...
            <dwc:GroupBox ID="GroupBox1" runat="server" Title="High volume product URLs">
                <dwc:CheckBox runat="server" ID="HighVolumeProductUrls" Name="/Globalsettings/System/Url/HighVolumeProductUrls/Enable" Label="Enable high volume product URLs" Info="Enable for sites with more than 10.000 products. Product URLs have to be disabled on page properties (set to 'Group')" />
                <dwc:RadioGroup runat="server" ID="RadioGroup1" Name="/Globalsettings/System/Url/HighVolumeProductUrls/Pattern" Label="Product URL pattern" Visible="true">
                    <dwc:RadioButton runat="server" ID="RadioButton2" Label="Use product id and variant id" FieldValue="ProductAndVariantId" Info="product-name-productid~variantid" />
                    <dwc:RadioButton runat="server" ID="RadioButton1" Label="Use product number if specified" FieldValue="SkuIfSpecified" Info="product-name-productnumber" />
                    <dwc:RadioButton runat="server" ID="RadioButton3" Label="Use product number for masters and productid/variant id for variants" FieldValue="SkuForMasterProductIdForVariants" Info="product-name-productnumber / product-name-productid~variantid" />
                </dwc:RadioGroup>
                <dwc:RadioGroup runat="server" ID="RadioGroup2" Name="/Globalsettings/System/Url/HighVolumeProductUrls/SeperatorScheme" Label="Product URL pattern" Visible="true">
                    <dwc:RadioButton runat="server" ID="RadioButton4" Label="Use dash and tilde as seperators (product-name-productid~variantid)" Info="Does not support '-' in SKUs/ProductIDs" FieldValue="DashTilde" />
                    <dwc:RadioButton runat="server" ID="RadioButton5" Label="Use tilde and underscore as seperators (product-name~product-id_variantid)" Info="Supports '-' in SKUs/ProductIDs" FieldValue="TildeUnderscore" />
                </dwc:RadioGroup>
                <dwc:CheckBox runat="server" ID="IncludeBrandname" Name="/Globalsettings/System/Url/HighVolumeProductUrls/IncludeBrandname" Label="Include brandname in url" Info="If a product has a brand specified, the brand will be part of the url " />
            ...
            <dwc:GroupBox ID="Sitemap" runat="server" Title="Sitemap.xml">
                <dwc:CheckBox runat="server" ID="UseUrlProviderForSitemap" Name="/Globalsettings/System/Url/UseUrlProviderForSitemap" Label="Use new URL providers for sitemap.xml nodes" />
            </dwc:GroupBox>
        </dwc:CardBody>
    </dwc:Card>
