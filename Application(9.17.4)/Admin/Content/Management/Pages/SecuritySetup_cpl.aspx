...
<asp:Content ContentPlaceHolderID="MainContent" runat="server">
    <dwc:Card runat="server">
        ...
        <dwc:CardBody runat="server">
            ...
            <dwc:GroupBox ID="gbImageSettings" Title="Restrictive image settings" runat="server">
                <dwc:CheckBox runat="server" ID="AntiSpam" Name="/Globalsettings/System/Security/Image/AntiSpamEnabled" Label="Enable restrictive image settings" />
                <dwc:InputNumber runat="server" ID="ImageWidth" Name="/Globalsettings/System/Security/Image/Width" Label="Max image width" Placeholder="2000" />
                <dwc:InputNumber runat="server" ID="ImageHeight" Name="/Globalsettings/System/Security/Image/Height" Label="Max image height" Placeholder="2000" />
                <dwc:InputNumber runat="server" ID="ImageQuality" Name="/Globalsettings/System/Security/Image/Quality" Label="Max image quality" Placeholder="95" />
                <dwc:InputNumber runat="server" ID="DuplicateImageRequests" Name="/Globalsettings/System/Security/Image/DuplicateImageRequests" Label="Maximum unique image parameters per IP" Placeholder="30" Info="<%# GetUniqueImageParamsForIp%>" />
                <dwc:SelectPicker runat="server" ID="ImageAction" Name="/Globalsettings/System/Security/Image/Action" Label="Action">
                    <asp:ListItem runat="server" Text="Intet valgt" Value="" />
                    <asp:ListItem runat="server" Text="BAN IP - same duration as specified in SQL Injection settings" Value="ban-ip" />
                    <asp:ListItem runat="server" Text="403 forbidden" Value="403" />
                    <asp:ListItem runat="server" Text="404 not found" Value="404" />
                </dwc:SelectPicker>
            </dwc:GroupBox>
            ...
            <dwc:GroupBox ID="GroupBox_WebApi" Title="Web Api" runat="server">
                <dwc:CheckBox runat="server" ID="WebApi_EnableCors" Name="/Globalsettings/System/Security/WebApi/DisableDwGeneratedCors" Label="Disable CORS (Allow All) headers" Info="Disables CORS headers added by Dynamicweb, allowing for custom CORS headers in web.config - REQUIRES RESTART" />
            </dwc:GroupBox>
