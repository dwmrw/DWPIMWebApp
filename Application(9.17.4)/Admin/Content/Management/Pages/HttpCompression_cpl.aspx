    ...
    <dwc:Card runat="server">
        ...
        <dwc:CardBody runat="server">
            ...
            <dwc:GroupBox runat="server" ID="groupbox2" Title="Image handler" DoTranslation="False">
                ...
                <dwc:InputNumber runat="server" ID="DefaultWebPQuality" Name="/Globalsettings/Settings/ImageHandler/DefaultWebPQuality" Label="Default webp quality" Min="-1" Max="100" Placeholder="50" Info="Overrides default webp quality (50). 1-100. Avoid too large setting to avoid performance problems. -1 = lossless compression" />
                <dwc:SelectPicker runat="server" ID="ConverterProvider" Name="/Globalsettings/Settings/ImageHandler/Providers/ImageConverterProvider" Label="Converter provider" Info="Sets the default image converter provider."></dwc:SelectPicker>
                <dwc:SelectPicker runat="server" ID="SizeProvider" Name="/Globalsettings/Settings/ImageHandler/Providers/ImageSizeProvider" Label="Size provider" Info="Sets the default image size provider."></dwc:SelectPicker>
                <dwc:SelectPicker runat="server" ID="AttributesProvider" Name="/Globalsettings/Settings/ImageHandler/Providers/ImageAttributesProvider" Label="Attributes provider" Info="Sets the default image attributes provider."></dwc:SelectPicker>
                <dwc:SelectPicker runat="server" ID="MetadataProvider" Name="/Globalsettings/Settings/ImageHandler/Providers/ImageMetadataProvider" Label="Metadata provider" Info="Sets the default image metadata provider."></dwc:SelectPicker>
            </dwc:GroupBox>
