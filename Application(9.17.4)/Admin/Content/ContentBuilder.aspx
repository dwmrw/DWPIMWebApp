...
<body class="boxed-fields sw-toggled">
    ...
    <% If Request("popout") Is Nothing %>
        ...
        <% End If %>
        <a href="javascript:void(0);" onclick="ContentBuilder.closeVisualEditor(<%=pageId%>)" class="back-to-content-btn" ><i class="<%=KnownIconInfo.ClassNameFor(KnownIcon.Clear, True)%>"></i> <dw:TranslateLabel runat="server" Text="Close Visual Editor" /></a>
    <% End If %>
    </div>
