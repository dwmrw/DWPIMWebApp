...
<head>
    ...
    <script type="text/javascript">
        ...
        function IsValidEmail(email) {
            var regExp = /^[\w\-_]+(\.[\w\-_]+)*@[\w\-_]+(\.[\w\-_]+)*\.[a-z]{2,255}$/i;
        ...
        function SendMailStep(submitForm) {
            ...
            var templateSelected = document.querySelector('[name="RedirectType"]:checked').value == "Template";
            if (templateSelected) {
                ...
                var mailPage = document.getElementById("RedirectPage");
                var formGroup = mailPage.closest(".form-group");
                if (mailPage.value == "") {
                    formGroup.classList.add("has-error");
                    $("helpRedirectPage").innerText = "<%=Translate.JsTranslate("required")%>";
                    $("helpRedirectPage").style.display = "block";
                    valid = false;
                } else {
                    formGroup.classList.remove("has-error");
                    $("helpRedirectPage").style.display = "none";
                }
            }
        ...
        function toggleRedirect(radio) {
            if (radio.value == 'Page') {
                $('RedirectPageDiv').style.display = 'block';
                $('MailTemplateFileDiv').style.display = 'none';
            } else {
                $('RedirectPageDiv').style.display = 'none';
                $('MailTemplateFileDiv').style.display = 'block';
            }
        }

        document.observe("dom:loaded", function () {
            toggleRedirect(document.querySelector('[name="RedirectType"]:checked'));
        ...
        <Content>
            <div class="col-md-0 boxed-fields">
                ...
                <dw:GroupBox runat="server">
                    ...
                    <dwc:RadioGroup ID="RedirectType" Name ="RedirectType" runat="server" Label ="Mail content">
                    ...
                    <div id="RedirectPageDiv">
                        <div class="form-group">
                            ...
                            <div class="form-group-input">
                                ...
                                <small class="help-block error" id="helpRedirectPage"></small>
                            </div>
                        </div>
                    </div>
                    <div id="MailTemplateFileDiv">                        
