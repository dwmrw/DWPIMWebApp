...
<dw:ModuleSettings ID="ModuleSettings1" runat="server" ModuleSystemName="BasicForms" Value="FormID, UseTemplate, Template, RedirectPage, ReceiptTemplateText, FormSubmitButtonText, MailSubject, MailSender, MailSenderUseUserEmail, MailSenderName, MailReplyto, MailReplytoUseUserEmail, MailRecipient, MailCC, MailBCC, UseMailTemplate, MailTemplate, MailRedirectPage, MailText, ReceiptSubject, ReceiptSenderName, ReceiptSender, ReceiptRecipient, ReceiptCC, ReceiptBCC, UseReceiptTemplate, ReceiptTemplate, ReceiptRedirectPage, ReceiptText, formSubmitAction, formSubmitPageAfterSave, formSubmitConfirmationTemplate, FormMaxSubmitAction, FormMaxSubmitsReachedPage, FormMaxSubmitsReachedTemplate, FormMaxSubmits, FormUploadPath, CreateUserOnSubmit, CreateNewUserGroupsHidden" />
...
<script type="text/javascript">
    ...
    function enableTemplate(elm, templateContainerId, pageContainerId) {
        document.getElementById(templateContainerId).style.display = "none";
        document.getElementById(pageContainerId).style.display = "none";
        if (elm.value == "1") {
            document.getElementById(templateContainerId).style.display = "";
        } else if (elm.value == "2") {
            document.getElementById(pageContainerId).style.display = "";
        }        
    }
...
<dw:GroupBox ID="GroupBox1" runat="server" Title="Formular" DoTranslation="true">
    <table class="formsTable">
        ...
        <tr>
            ...
            <td>
                <div class="radio">
                    <input type="radio" name="UseTemplate" id="UseAutomatic" onclick="enableTemplate(this, 'templateRow', 'pageRow');" value="0" runat="server" /><label for="UseAutomatic">Automatic</label>
                </div>
                <div class="radio">
                    <input type="radio" name="UseTemplate" id="UseTemplate" onclick="enableTemplate(this, 'templateRow', 'pageRow');" value="1" runat="server" /><label for="UseTemplate">Template</label>
                </div>
                <div class="radio">
                    <input type="radio" name="UseTemplate" id="UsePage" onclick="enableTemplate(this, 'templateRow', 'pageRow');" value="2" runat="server" /><label for="UsePage">Page</label>
                </div>
            </td>
        </tr>
        <tr id="pageRow">
            <td>
                <dw:TranslateLabel ID="TranslateLabel3" runat="server" Text="Page" />
            </td>
            <td>
                <dw:LinkManager runat="server" ID="RedirectPage" DisableFileArchive="true" DisableParagraphSelector="true" />
            </td>
        </tr>
        <tr id="templateRow">
            <td>
    ...
    <table class="formsTable">
        ...
        <tr>
            ...
            <td>
                <div id="MailSenderCell" class="m-b-10" runat="server">
                    ...
                    <div><small>user@domain.com</small></div>
                </div>
        ...
        <tr>
            ...
            <td>
                ...
                <div><small>user@domain.com, user2@domain.com</small></div>
            </td>
        </tr>
        <tr>
            <td>
        ...
        <tr>
            ...
            <td>
                <div class="radio">
                    <input type="radio" name="UseMailTemplate" id="UseMailAutomatic" onclick="enableTemplate(this, 'MailTemplateRow', 'MailPageRow');" value="0" runat="server" /><label for="UseMailAutomatic">Automatic</label>
                </div>
                <div class="radio">
                    <input type="radio" name="UseMailTemplate" id="UseMailTemplate" onclick="enableTemplate(this, 'MailTemplateRow', 'MailPageRow');" value="1" runat="server" /><label for="UseMailTemplate">Template</label>
                </div>
                <div class="radio">
                    <input type="radio" name="UseMailTemplate" id="UseMailPage" onclick="enableTemplate(this, 'MailTemplateRow', 'MailPageRow');" value="2" runat="server" /><label for="UseMailPage">Page</label>
                </div>
            </td>
        </tr>
        <tr id="MailPageRow">
            <td>
                <dw:TranslateLabel ID="TranslateLabel19" runat="server" Text="Page" />
            </td>
            <td>
                <dw:LinkManager runat="server" ID="MailRedirectPage" DisableFileArchive="true" DisableParagraphSelector="true" />
            </td>
        </tr>
...
<dw:GroupBox ID="GroupBox3" runat="server" Title="Kvittering" DoTranslation="true">
    <table class="formsTable">
        ...
        <tr id="Tr1" runat="server">
            ...
            <td>
                <input type="Text" name="ReceiptSender" id="ReceiptSender" runat="server" value="" maxlength="255" class="std" title="user@domain.com" />
                <div><small>user@domain.com, user2@domain.com</small></div>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td>
                <input type="Text" name="ReceiptCC" id="ReceiptCC" runat="server" value="" maxlength="255" class="std" title="user@domain.com, user2@domain.com" />
                <div><small>user@domain.com, user2@domain.com</small></div>
            </td>
        </tr>
        <tr>
            ...
            <td>
                <input type="Text" name="ReceiptBCC" id="ReceiptBCC" runat="server" value="" maxlength="255" class="std" title="user@domain.com, user2@domain.com" />
                <div><small>user@domain.com, user2@domain.com</small></div>
            </td>
        </tr>
        <tr>
            ...
            <td>
                <div class="radio">
                    <input type="radio" name="UseReceiptTemplate" id="UseReceiptAutomatic" onclick="enableTemplate(this, 'ReceiptTemplateRow', 'ReceiptPageRow');" value="0" runat="server" /><label for="UseReceiptAutomatic">Automatic</label>
                </div>
                <div class="radio">
                    <input type="radio" name="UseReceiptTemplate" id="UseReceiptTemplate" onclick="enableTemplate(this, 'ReceiptTemplateRow', 'ReceiptPageRow');" value="1" runat="server" /><label for="UseReceiptTemplate">Template</label>
                </div>
                <div class="radio">
                    <input type="radio" name="UseReceiptTemplate" id="UseReceiptPage" onclick="enableTemplate(this, 'ReceiptTemplateRow', 'ReceiptPageRow');" value="2" runat="server" /><label for="UseReceiptPage">Page</label>
                </div>
            </td>
        </tr>
        <tr id="ReceiptPageRow">
            <td>
                <dw:TranslateLabel ID="TranslateLabel20" runat="server" Text="Page" />
            </td>
            <td>
                <dw:LinkManager runat="server" ID="ReceiptRedirectPage" DisableFileArchive="true" DisableParagraphSelector="true" />
            </td>
        </tr>
...
<script>
    ...
    enableTemplate(document.querySelector("[name='UseTemplate']:checked"), 'templateRow', 'pageRow');
    enableTemplate(document.querySelector("[name='UseMailTemplate']:checked"), 'MailTemplateRow', 'MailPageRow');
    enableTemplate(document.querySelector("[name='UseReceiptTemplate']:checked"), 'ReceiptTemplateRow', 'ReceiptPageRow');
</script>
