        ...
        <dwc:Card runat="server">
            ...
            <dwc:CardBody runat="server">
                <dw:GroupBox runat="server" Title="Endpoint information" ID="GroupBox1">
                    ...
                    <dwc:CheckBox runat="server" ID="cbDynamicwebService" Label="Connects to standard Dynamicweb ERP service" OnClick="useDynamicwebServiceClick()" />
                    ...
                    <dwc:SelectPicker runat="server" ID="spRequestType" CssClass="selectpicker" Name="spRequestType" Label="Type">
                        ...
                        <asp:ListItem Text="PATCH" Value="PATCH"></asp:ListItem>
                    </dwc:SelectPicker>
                    ...
                    <dw:GroupBox runat="server" Title="Endpoint authentication" ID="AuthenticationGroupBox">
                        <div class="form-group">
                            ...
                            <div class="form-group-input">
                                <dwc:SelectPicker runat="server" ID="AuthenticationList" Label="" ClientIDMode="Static" ValidationMessage="">
