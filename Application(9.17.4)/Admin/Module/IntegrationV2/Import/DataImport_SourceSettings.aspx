    ...
    <content>
        <div class="col-md-5 source-settings">
            ...
            <dwc:GroupBox runat="server" ID="SourceTableGroupbox">
                ...
                <dwc:SelectPicker runat="server" ID="ImportKeySelector" Multiple="true" Name ="ImportKeySelector" Label="Import key" ValidationMessage="" ClientIdMode="Static"></dwc:SelectPicker>
            </dwc:GroupBox>
