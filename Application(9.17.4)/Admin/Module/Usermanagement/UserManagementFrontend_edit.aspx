...
<script type="text/javascript">
    ...
    function toggleConfirmationRedirect() {
        if ($('ConfirmationRedirectTypePage').checked) {
            $('ConfirmationRedirectPageDiv').style.display = 'block';
            $('ConfirmationRedirectTemplateDiv').style.display = 'none';
        } else {
            $('ConfirmationRedirectPageDiv').style.display = 'none';
            $('ConfirmationRedirectTemplateDiv').style.display = 'block';
        }
    }

    function toggleAutoLogin() {
        $('CreateProfileAutoLoginDiv').style.display = $('CreateProfileApprovalRadioNone').checked ? 'block' : 'none';
        $('ConfirmationEmailAlwaysSendDiv').style.display = $('CreateProfileApprovalRadioByAdmin').checked ? 'block' : 'none';
        ...
        $('UserConfirmationEmailGroup').style.display = $('CreateProfileApprovalRadioByUser').checked || $('ConfirmationEmailAlwaysSend').checked ? 'block' : 'none';
    }
    ...
    window["paragraphEvents"].setBeforeSave(function () {
        if ($('ConfirmationRedirectTypePage').checked) {
            clearFileSelection($('FM_ConfirmationEmailTemplate'));
        } else {
            $('ConfirmationRedirectPage').value = "";
        }

        if ($('NotificationRedirectTypePage').checked) {
            clearFileSelection($('FM_NotificationEmailTemplate'));
        } else {
            $('NotificationRedirectPage').value = "";
        }

        if ($('UserNotificationRedirectTypePage').checked) {
            clearFileSelection($('FM_UserNotificationEmailTemplate'));
        } else {
            $('UserNotificationRedirectPage').value = "";
        }

        if ($('PasswordRecoveryRedirectTypePage').checked) {
            clearFileSelection($('FM_PasswordRecoveryEmailTemplate'));
        } else {
            $('PasswordRecoveryEmailRedirectPage').value = "";
        }
    });
</script>
        ...
        <table class="formsTable">
            ...
            <tr>
                ...
                <td>
                    ...
                    <div id="ConfirmationEmailAlwaysSendDiv" style="margin: 5px 0px 10px 10px;">
                        <dw:CheckBox ID="ConfirmationEmailAlwaysSend" name="ConfirmationEmailAlwaysSend" runat="server" Label="Send confirmation mail" onclick="javascript:toggleAutoLogin();" />
                    </div>
            ...
            <tr>
                <td style="vertical-align:top;"></td>
                <td>
                    <dw:CheckBox ID="SetProfile" name="SetProfile" Label="Set profile" runat="server" />
                </td>
            </tr>
    ...
    <div id="UserConfirmationEmailGroup">
        <dw:GroupBox ID="GroupBox14" runat="server" Title="User confirmation e-mail" DoTranslation="true">
            <table class="formsTable">
                <tr>
                    <td>
                        <dw:TranslateLabel runat="server" Text="On user confirmation, redirect to" />
                    </td>
                    <td>
                        <div class="radio">
                            <input type="radio" runat="server" name="ConfirmationRedirectType" id="ConfirmationRedirectTypePage" onclick="javascript:toggleConfirmationRedirect();" />
                            <label for="ConfirmationRedirectTypePage">
                                <dw:TranslateLabel runat="server" Text="Page" />
                            </label>
                        </div>
                        <div class="radio">
                            <input type="radio" runat="server" name="ConfirmationRedirectType" id="ConfirmationRedirectTypeTemplate" onclick="javascript:toggleConfirmationRedirect();" />
                            <label for="ConfirmationRedirectTypeTemplate">
                                <dw:TranslateLabel runat="server" Text="Template" />
                            </label>
                        </div>
                            <div id="ConfirmationRedirectPageDiv">
                            <dw:LinkManager runat="server" ID="ConfirmationRedirectPage" DisableFileArchive="true" DisableParagraphSelector="true" />
                        </div>
                        <div id="ConfirmationRedirectTemplateDiv"> 
...
<div id="ErrorMessagesDIV">
    <dw:GroupBox ID="GroupBox19" runat="server" Title="Error messages" DoTranslation="true">
        <table class="formsTable">
            ...
            <tr>
                <td>
                    <label for="ErrorDuplicateEmail">
                        <dw:TranslateLabel runat="server" Text="Duplicate e-mail" />
                    </label>
                </td>
                <td>
                    <input type="text" class="std" runat="server" name="ErrorDuplicateEmail" id="ErrorDuplicateEmail" value="" />
                </td>
            </tr>
            <tr>
                <td>
