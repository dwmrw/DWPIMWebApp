        ...
        <form id="MainForm" runat="server">
            <dwc:Card runat="server">
                ...
                <dwc:CardBody runat="server">
                    ...
                    <dwc:GroupBox ID="InheritanceGroup" Title="Inherit rules for primary image" runat="server">                          
                        <dwc:CheckBox ID="InheritDefaultImageAcrossVariants" runat="server" Label ="Inherit across Variants" />
                        <dwc:CheckBox ID="InheritDefaultImageAcrossLanguages" runat="server" Label ="Inherit across Language" />
                    </dwc:GroupBox>
