        ...
        <form id="Form1" method="post" runat="server">
            ...
            <dwc:GroupBox runat="server" Title="Indstillinger">
                <table class="formsTable">
                    ...
                    <tr>
                        <td>
                            <dw:TranslateLabel ID="tLabelreversechargeforVat" runat="server" Text="Reverse charge for VAT" />
                        </td>
                        <td>
                           <div>
                              <dw:CheckBox ID="ReverseChargeFOrVat" Name="ReverseChargeForVat" runat="server" Label="Reverse charge for VAT" />
                           </div>
                        </td>
                    </tr>                   
                    <tr>
                        <td>
                            <dw:TranslateLabel ID="tLabelVatPostingGroup" runat="server" Text="VAT posting group" />
                        </td>
                        <td>
                           <div>                              
                               <asp:TextBox ID="VatPostingGroup" Label="VAT posting group" MaxLength="20" CssClass="std" runat="server"></asp:TextBox>
                           </div>
                        </td>
                    </tr>                   
                </table>
