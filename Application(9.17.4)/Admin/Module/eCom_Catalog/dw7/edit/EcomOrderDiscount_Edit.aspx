                    ...
                    <table class="formsTable">
                        ...
                        <tr id="amountDiv" style="display: none;">
                            ...
                            <td>
                              ...
                              <div>
                                <dw:CheckBox ID="DiscountAmountIncludesVat" Name="DiscountAmountIncludesVat" runat="server" Label="Amount includes VAT" />
                            </div>
                           </td>
                        </tr>
        ...
        <div class="card">
            <dwc:GroupBox Title="Users and Groups" runat="server">
                <table class="formsTable">
                    ...
                    <tr id="AnonymousUser">
                            <td>
                                <dw:TranslateLabel runat="server" Text="Only anonymous users" />
                            </td>
                            <td>
                                <dw:CheckBox ID="AnonymousUsers" FieldName="AnonymousUsers" runat="server" />                                
                            </td>
                        </tr>
                    <tr>
                        <td>
