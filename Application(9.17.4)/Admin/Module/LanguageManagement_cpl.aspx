    ...
    <dwc:Card runat="server">
        ...
        <dwc:CardBody runat="server">
            <dwc:GroupBox runat="server" Title="Language versions">
                <dwc:CheckBox runat="server" Name="/Globalsettings/Modules/LanguageManagement/DeactivateParagraphOnNew" Label="Unpublish new paragraphs and rows" Info="When new paragraphs and rows are created on the master, the copy created on the language will be unpublished" />
                <dwc:CheckBox runat="server" Name="/Globalsettings/Modules/LanguageManagement/DeactivatePageOnNew" Label="Unpublish new pages"  Info="When new pages are created on the master, the copy created on the language will be unpublished" />
