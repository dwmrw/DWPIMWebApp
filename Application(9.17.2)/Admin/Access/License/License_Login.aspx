                ...
                <div id="boxinner">
                    ...
                    <asp:Panel ID="step2" CssClass="step" runat="server" DefaultButton="logonButton">
                        ...
                        <div id="filessetupoptionsDone">
                            ...
                            <p>
                                If you do not have a valid login, go back and install a trial and contact Dynamicweb at care@dynamicweb.com to get a login and a valid license.
                            </p>
                        </div>
                    ...
                    <asp:Panel ID="step3" CssClass="step" runat="server">
                        ...
                        <div id="databasesetupoptions">
                            ...
                            <p>
                                Unable to find your customer? Contact our service desk (care@dynamicweb.com) to get the issue fixed. You can use a trial until license is registered.
                            </p>
                            <p>
