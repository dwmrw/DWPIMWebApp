...
<updates>
    ...
    <current version="2248" releasedate="01-03-2024" />
    
    <package version="2248" date="01-03-2024">
        <database file="Ecom.mdb">
            <AccessUserCard>
	            <sql conditional="">
                    IF NOT EXISTS (SELECT 1 FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'AccessUserCard' AND COLUMN_NAME = 'AccessUserCardExpirationMonth') 
                    BEGIN ALTER TABLE [AccessUserCard] ADD [AccessUserCardExpirationMonth] [int] NULL END;

                    IF NOT EXISTS (SELECT 1 FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'AccessUserCard' AND COLUMN_NAME = 'AccessUserCardExpirationYear') 
                    BEGIN ALTER TABLE [AccessUserCard] ADD [AccessUserCardExpirationYear] [int] NULL END;
                </sql>
            </AccessUserCard>
        </database>
    </package>

    <package version="2247" date="07-07-2022">
        <database file="Ecom.mdb">
            <Ecom7Tree>
                <sql conditional="SELECT COUNT(*) FROM Ecom7Tree WHERE TreeChildPopulate = 'FIELDSHOPPERMISSIONS' AND ParentId = 94">
                    UPDATE Ecom7Tree SET ParentId = 94 WHERE TreeChildPopulate = 'FIELDSHOPPERMISSIONS' AND ParentId = 93
                </sql>
            </Ecom7Tree>
        </database>
    </package>

    <package version="2246" releasedate="05-07-2022">
        <database file="Ecom.mdb">
            <EcomShippings>
                <sql conditional="SELECT COUNT(*) FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'DynamicStructureLevels' AND COLUMN_NAME = 'DynamicStructureLevelUseRelationOnProductCreate'">
                    ALTER TABLE [DynamicStructureLevels] ADD [DynamicStructureLevelUseRelationOnProductCreate] [bit] NOT NULL DEFAULT 0
                </sql>
                <sql conditional="SELECT COUNT(*) FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'DynamicStructureLevels' AND COLUMN_NAME = 'DynamicStructureLevelUseCompleteness'">
                    ALTER TABLE [DynamicStructureLevels] ADD [DynamicStructureLevelUseCompleteness] [bit] NOT NULL DEFAULT 0
                </sql>
            </EcomShippings>
        </database>
    </package>

    <package version="2245" releasedate="04-07-2022">
        <database file="Ecom.mdb">
            <EcomShippings>
                <sql conditional="SELECT COUNT(*) FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'EcomShippings' AND COLUMN_NAME = 'ShippingUsePriceWithVat'">
                    ALTER TABLE [EcomShippings] ADD [ShippingUsePriceWithVat] [bit] NOT NULL DEFAULT 0
                </sql>
            </EcomShippings>
        </database>
    </package>

    <package version="2244" date="07-06-2022">
        <database file="Ecom.mdb">
            <Ecom7Tree>
                <sql conditional="SELECT COUNT(*) FROM Ecom7Tree WHERE TreeChildPopulate = 'FIELDSHOPPERMISSIONS'">
                    INSERT INTO Ecom7Tree (ParentId, Text, Alt,TreeIcon, TreeUrl, TreeChildPopulate, TreeSort, TreeHasAccessModuleSystemName)
                    VALUES (93, 'Field permissions', 7, 'tree/btn_properties.png','/Admin/Module/eCom_Catalog/dw7/lists/EcomFieldPermissions_List.aspx','FIELDSHOPPERMISSIONS',124, NULL);
                </sql>
            </Ecom7Tree>
        </database>
    </package>

    <package version="2243" releasedate="31-05-2022">
    ...
    <package version="2242" releasedate="05-05-2022">
    ...
    <package version="2241" releasedate="26-04-2022">
        <folder source="/Files/System/Integration/TestTool/" target="/Files/System/Integration/" />
    </package>

    <package version="2240" releasedate="26-04-2022">
