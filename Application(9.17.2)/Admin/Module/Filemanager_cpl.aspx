    ...
    <dwc:Card runat="server">
        ...
        <dwc:CardBody runat="server">
            <dwc:GroupBox Title="Upload" runat="server">
                ...
                <dwc:InputText runat="server" id="GoogleMapsClientID" Name="/Globalsettings/Modules/Filemanager/Upload/AllowedExtensions" label="Allowed extensions" Info="Allow only specified extensions, i.e. '.pdf, .docx, .pptx'" />
                <dwc:InputText runat="server" id="InputText1" Name="/Globalsettings/Modules/Filemanager/Upload/DisAllowedExtensions" label="Disallowed extensions" Placeholder="" Info="Disallow specified extensions, i.e. '.exe, .vbs, .bat'" />
            </dwc:GroupBox>
