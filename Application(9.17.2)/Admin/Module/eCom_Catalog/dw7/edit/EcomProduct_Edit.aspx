...
var _MetaKeywordsCounterMaxId = '<%=MetaKeywordsCounterMax.ClientID%>';
        ...
        var isUrlRegex = /^(http:\/\/)|(https:\/\/)|(ftp:\/\/)|(\/\/)/i;
                                    ...
                                    <div class="row">
                                        <div class="card-section-8">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="card-section-6 <%= GetCommonFieldCssClass(FieldElementsSection.Settings, ProductDataBaseField.ProductPoints, ProductDataBaseField.ProductManufacturerId) %> ">
                                                    ...
                                                    <div class="form-group number-validator-container <%= GetCommonFieldCssClass(FieldElementsSection.Settings, ProductDataBaseField.ProductPoints)%>" >
                                                        <label class="form-label"><%= GetCommonFieldTitle(FieldElementsSection.Settings, ProductDataBaseField.ProductPoints)%></label>
                                                        ...
                                                        <%=GetValidateSpanBlock(ProductDataBaseField.ProductPoints, "DefaultPoints")%>
                                                    </div>
                                                    <%End If%>
