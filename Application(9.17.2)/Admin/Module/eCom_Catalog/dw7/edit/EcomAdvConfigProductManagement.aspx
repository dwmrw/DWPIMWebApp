...
<asp:Content ContentPlaceHolderID="MainContent" runat="server">
   ...
   <dwc:GroupBox runat="server" Title="Indexes">
    ...
    <dwc:GroupBox runat="server" Title="Product Edit">
       <dwc:CheckBox runat="server" Label="Do not copy Field content when adding new Language on Product" Value="true" ID="DontCopyProductFieldContentToNewLanguage" Name="/Globalsettings/Ecom/PIM/DontCopyProductFieldContentToNewLanguage" />
       <dwc:CheckBox runat="server" Label="Show frontend field display groups in product edit" Info="Field display groups with 'Use in frontend' enabled will also be available at product editing" Value="true" ID="ShowFrontendFieldDisplayGroupsInProductEdit" Name="/Globalsettings/Ecom/PIM/ShowFrontendFieldDisplayGroupsInProductEdit" />
    </dwc:GroupBox>
