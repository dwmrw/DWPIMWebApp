...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <dwc:GroupBox runat="server" Title="Indstillinger">
        ...
        <dwc:RadioGroup runat="server" ID="FixedAmountDiscountVatPercent" Name="/Globalsettings/Ecom/Price/FixedAmountDiscountVatPercent" SelectedValue ="UseCountryVat" Label="Fixed amount discount VAT percent">
            <dwc:RadioButton runat="server" FieldValue="UseCountryVat" Label="Use country VAT" />
            <dwc:RadioButton runat="server" FieldValue="UseSubTotalVat" Label="Use weighted VAT from subtotal" />
            <dwc:RadioButton runat="server" FieldValue="UseTotalVat" Label="Use weighted VAT from total" />
        </dwc:RadioGroup>
