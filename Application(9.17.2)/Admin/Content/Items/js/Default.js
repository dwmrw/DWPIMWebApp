...
Dynamicweb.Items.ListItem.initialize = function (parameters) {
    ...
    listItem._paragraphId = parameters.paragraphId;
...
Dynamicweb.Items.ListItem.prototype.openListItemDialog = function (itemId, isNew, disableSave, sort) {
    ...
    var url = "/Admin/Content/Items/Editing/ItemListEdit.aspx?ItemID={ItemID}&New={IsNew}&DisableSave={DisableSave}&Sort={Sort}&PageId={PageId}&ParagraphId={ParagraphId}&Caller={ListId}&ItemType={ItemType}&IsDraft={IsDraft}";
    if (this._sortBy) {
