...
(function (ContentBuilder) {
    ...
    var GridColumn = /** @class */ (function () {
        ...
        GridColumn.prototype.deleteColumn = function () {
            ...
            if (!confirm("Are you sure you want to delete the column/paragraph with name: '".concat(this.paragraphName, "' and ID: '").concat(this.paragraphId, "'?")))
                return;
            Helpers.showSpinner();
            var url = "/Admin/Content/Paragraph/Paragraph_Delete.aspx?ID=".concat(this.paragraphId, "&PageID=").concat(this.row.grid.pageId, "&source=VisualEditor");
            fetch(url).then(function (resp) {
                if (resp.ok) {
                    Helpers.reloadEditor();
                }
    ...
    function closeVisualEditor(pageId) {
        ...
        location.href = "/Admin/Content/ParagraphList.aspx?PageID=".concat(pageId, "&NavigatorSync=RefreshParentAndSelectPage");
    }
    ...
    ContentBuilder.reloadVisualEditor = reloadVisualEditor;
    //#endregion
